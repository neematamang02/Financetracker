    ...
    <>
      <div className="dashboardallcontents">
        ...
        <div className="grid gap-3 mt-5 sm:grid-cols-none lg:grid-cols-3 xl:grid-cols-3">
          <div className="h-auto w-auto bg-white p-6 rounded-xl">
            <p className="text-gray-500 mb-4">Current Savings</p>
            <h1 className="font-bold text-2xl">RS.40000</h1>
          </div>
          <div className="h-auto w-auto bg-white p-6 rounded-xl">
            <p className="text-gray-500 mb-4">Total Income</p>
            <h1 className="font-bold text-2xl">RS.100000</h1>
          </div>
          <div className="h-auto w-auto bg-white p-6 rounded-xl">
            <p className="text-gray-500 mb-4">Total Expenses</p>
            <h1 className="font-bold text-2xl">RS.60000</h1>
          </div>
        </div>
